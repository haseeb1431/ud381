...
public class SentenceWordCountTopology {
  ...
  static class SplitSentenceBolt extends BaseRichBolt {
	  ...
	  public void execute(Tuple tuple){
		  ...
		  for (int i = 0; i < tokens.length; i++) {
			  collector.emit(new Values(tokens[i]));
		  }
	  }
	  ...
	  {
		  outputFieldsDeclarer.declare(new Fields("Split-word"));
	  }
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    builder.setBolt("sentenceSplit-bolt", new SplitSentenceBolt(), 15).shuffleGrouping("sentence-spout");

    // attach the count bolt using fields grouping - parallelism of 15
    builder.setBolt("count-bolt", new CountBolt(), 15).fieldsGrouping("sentenceSplit-bolt", new Fields("Split-word"));
